...
## Edita o JSON com as configurações

```bash
code /home/venzel/.vscode/extensions/dracula-theme.theme-dracula-2.24.2/theme/dracula-soft.json
```
...
```json
{
    ...
    "colors": {
        ...
        "terminal.ansiBlack": "#181B23",
        "terminal.ansiRed": "#FF5555",
        "terminal.ansiGreen": "#50FA7B",
        "terminal.ansiYellow": "#F1FA8C",
        "terminal.ansiBlue": "#BD93F9",
        "terminal.ansiMagenta": "#9AA7E9",
        "terminal.ansiCyan": "#8BE9FD",
        "terminal.ansiWhite": "#F8F8F2",
        "contrastBorder": "#0A0C12",
        "focusBorder": "#6272A4",
        "foreground": "#63667d",
        "selection.background": "#BD93F9",
        "errorForeground": "#FF5555",
        "button.background": "#2B2C3C",
        "button.foreground": "#F8F8F2",
        "dropdown.background": "#343746",
        "dropdown.border": "#0A0C12",
        "dropdown.foreground": "#F8F8F2",
        "input.background": "#0A0C12",
        "input.foreground": "#F8F8F2",
        "input.border": "#0A0C12",
        "input.placeholderForeground": "#6272A4",
        "inputOption.activeBorder": "#BD93F9",
        "inputValidation.infoBorder": "#52109d",
        "inputValidation.warningBorder": "#FFB86C",
        "inputValidation.errorBorder": "#FF5555",
        "badge.foreground": "#f4bf75",
        "badge.background": "#2B2C3C",
        "progressBar.background": "#f4bf75",
        "list.activeSelectionBackground": "#343746",
        "list.inactiveSelectionForeground": "#F8F8F2",
        "list.activeSelectionForeground": "#F8F8F2",
        "list.dropBackground": "#2B2C3C",
        "list.focusBackground": "#2B2C3C75",
        "list.highlightForeground": "#8BE9FD",
        "list.hoverBackground": "#2B2C3C75",
        "list.hoverForeground": "#F8F8F2",
        "list.inactiveSelectionBackground": "#2B2C3C75",
        "list.warningForeground": "#FFB86C",
        "list.errorForeground": "#FF5555",
        "activityBar.background": "#181B23",
        "activityBar.inactiveForeground": "#434855",
        "activityBar.foreground": "#F8F8F2",
        "activityBar.activeBorder": "#f4bf75",
        "activityBar.activeBackground": "#BD93F910",
        "activityBarBadge.background": "#f4bf75",
        ...
        "editorGroup.dropBackground": "#2B2C3C70",
        "editorGroupHeader.tabsBackground": "#0A0C12",
        "tab.activeBackground": "#151720",
        "tab.activeForeground": "#F8F8F2",
        "tab.border": "#0A0C12",
        "tab.activeBorderTop": "#f4bf75",
        "tab.inactiveBackground": "#0A0C12",
        "tab.inactiveForeground": "#484b5e",
        "editorCursor.background": "#f4bf75",
        "editorCursor.foreground": "#f4bf75",
        "editor.foreground": "#F8F8F2",
        "editor.background": "#181B23",
        "editorLineNumber.foreground": "#2B2C3C",
        "editor.selectionBackground": "#2B2C3C",
        "editor.selectionHighlightBackground": "#424450",
        "editor.foldBackground": "#191a23",
        "editor.wordHighlightBackground": "#8BE9FD50",
        "editor.wordHighlightStrongBackground": "#50FA7B50",
        "editor.findMatchBackground": "#FFB86C80",
        "editor.findMatchHighlightBackground": "#FFFFFF40",
        "editor.findRangeHighlightBackground": "#2B2C3C75",
        "editor.hoverHighlightBackground": "#8BE9FD50",
        "editor.lineHighlightBorder": "#2B2C3C",
        ...
        "editorOverviewRuler.border": "#0A0C12",
        ...
        "panel.border": "#BD93F9",
        "panelTitle.activeBorder": "#52109d",
        "panelTitle.activeForeground": "#F8F8F2",
        "panelTitle.inactiveForeground": "#6272A4",
        "statusBar.background": "#0A0C12",
        "statusBar.foreground": "#F8F8F2",
        "statusBar.debuggingBackground": "#FF5555",
        "statusBar.debuggingForeground": "#0A0C12",
        ...
        "titleBar.activeBackground": "#181B23",
        "titleBar.activeForeground": "#F8F8F2",
        "titleBar.inactiveBackground": "#FFB86C",
        "titleBar.inactiveForeground": "#6272A4",
        "notification.background": "#0A0C12",
        "notification.foreground": "#F8F8F2",
        "notification.buttonBackground": "#2B2C3C",
        "notification.buttonForeground": "#F8F8F2",
        "notification.buttonHoverBackground": "#2B2C3C75",
        ...
        "debugToolBar.background": "#181B23",
        "walkThrough.embeddedEditorBackground": "#181B23",
        "settings.headerForeground": "#F8F8F2",
        "settings.modifiedItemForeground": "#FFB86C",
        "settings.modifiedItemIndicator": "#FFB86C",
        "settings.dropdownBackground": "#181B23",
        "settings.dropdownForeground": "#F8F8F2",
        "settings.dropdownBorder": "#0A0C12",
        "settings.checkboxBackground": "#181B23",
        "settings.checkboxForeground": "#F8F8F2",
        "settings.checkboxBorder": "#0A0C12",
        "settings.textInputBackground": "#181B23",
        "settings.textInputForeground": "#F8F8F2",
        "settings.textInputBorder": "#0A0C12",
        "settings.numberInputBackground": "#181B23",
        "settings.numberInputForeground": "#F8F8F2",
        "settings.numberInputBorder": "#0A0C12",
        "breadcrumb.foreground": "#6272A4",
        "breadcrumb.background": "#0A0C12",
        "breadcrumb.focusForeground": "#F8F8F2",
        "breadcrumb.activeSelectionForeground": "#F8F8F2",
        "breadcrumbPicker.background": "#0A0C12",
